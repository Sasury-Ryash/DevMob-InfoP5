      ...
      body: Center(
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              Text(
                  'Bem vindo ao sistema de cadastro de clientes! Por favor, faça login.',
                  style: TextStyle(
                    fontSize: 30,
      ...
      body: Center(
        child: Column(
          ...
          children: [
            ...
            Text(
              '        Este é o sistema de cadastro de clientes, por enquanto você poderá adicionar quantos funcionários desejar em cada uma das quatro categorias fornecidas. Para acessá-las, basta clicas nas três barras horizontais no canto superior esquerdo da tela.',
              style: TextStyle(
                fontSize: 20,
                color: Colors.black,
              ),
          ...
          ListTile(
            ...
            onTap: () {
              Navigator.push(
                ...
                MaterialPageRoute(
                    builder: (context) =>
                        CadastroPage(title: 'Adicionar cliente')),
              );
            },
          ),
          ListTile(
        ...
        itemBuilder: (context, index) {
          return Card(
            ...
            child: ListTile(
              ...
              subtitle: Text(listaCadastros[index].cpf),
              : Text(listaCadastros[index].cpf),
              trailing: Row(
...
class _EditCadastroPageState extends State<EditCadastroPage> {
  ...
  void initState() {
    ...
    cpfController.text = widget.cadastro.cpf;
    telController.text = widget.cadastro.tel;
  }
            ...
            ElevatedButton(
              onPressed: () {
                if (nomeController.text.isNotEmpty && cpfController.text.isNotEmpty) {
                  ...
                  ScaffoldMessenger.of(context).showSnackBar(
                    SnackBar(
                      content: Text('Os campos CPF e NOME são obrigatórios.'),
                    ),
                  );
                }
              },
